...
namespace application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    TermsOfService = new Uri("https://www.linkedin.com/in/ruanbelentani/"),
                    Contact = new OpenApiContact
                    {
                        Name = "Ruan Belentani",
                        Email = "rabelentani@gmail.com",
                        Url = new Uri("https://www.linkedin.com/in/ruanbelentani/")
                    },
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (Environment.GetEnvironmentVariable("MIGRATION") != null && 
                Environment.GetEnvironmentVariable("MIGRATION").ToLower() == "APLICAR".ToLower())
            {
